...
const productsData: Prisma.ProductCreateInput[] = [
  {
    ...
    description:
      "Slightly used iPhone 13 Pro Max, 256GB, Graphite. Excellent condition with minor signs of wear. Includes original box and cable.",
    price: new Prisma.Decimal(750.0),
    imageUrl:
      "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-13-pro-max-graphite-select?wid=470&hei=556&fmt=jpeg&qlt=95&.v=1645552345944",
    stockQuantity: 15,
  ...
  },
  {
    ...
    description:
      "Professionally refurbished Samsung Galaxy S21 Ultra, 128GB, Phantom Black. Tested and certified, comes with a 90-day warranty.",
    price: new Prisma.Decimal(550.0),
  ...
  },
  {
    ...
    description:
      "Used Google Pixel 6, 128GB, Stormy Black. Good condition with some cosmetic scratches. Fully functional.",
    price: new Prisma.Decimal(320.0),
    imageUrl:
      "https://www.bhphotovideo.com/images/images2500x2500/google_ga02910_us_pixel_6_dual_sim_128gb_1665072.jpg",
    stockQuantity: 10,
    minimumOrderQuantity: 1,
    brand: "Google",
    condition: "used-good",
  },
  {
    ...
    description:
      "Used OnePlus 9 Pro, 256GB, Morning Mist. Excellent condition, includes Warp Charger.",
    price: new Prisma.Decimal(480.0),
  ...
  },
  {
    ...
    description:
      "Refurbished Xiaomi Mi 11, 128GB, Horizon Blue. Full working order, 6-month warranty.",
    price: new Prisma.Decimal(400.0),
    imageUrl:
  ...
  },
  {
    ...
    price: new Prisma.Decimal(450.0),
    imageUrl:
      "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-12-black-select-2020?wid=470&hei=556&fmt=jpeg&qlt=95&.v=1604343702000",
    stockQuantity: 20,
    brand: "Apple",
    condition: "used-good",
    minimumOrderQuantity: 1,
  },
  {
    ...
    price: new Prisma.Decimal(420.0),
  ...
  },
  {
    ...
    price: new Prisma.Decimal(580.0),
    imageUrl:
      "https://image.oppo.com/content/dam/oppo/product-asset-library/find/fussi/2116x1668.png",
    stockQuantity: 7,
    brand: "Oppo",
    condition: "refurbished",
    minimumOrderQuantity: 1,
  },
  {
    ...
    description:
      "Used Realme GT Master Edition, 128GB, Voyager Grey. Unique suitcase design, great state.",
    price: new Prisma.Decimal(250.0),
    imageUrl:
      "https://www.kibotek.com/wp-content/uploads/2021/09/kiboTEK_REALME_GT_MASTER_EDITION_008.png",
    stockQuantity: 11,
    brand: "Realme",
    condition: "used-like-new",
    minimumOrderQuantity: 1,
  },
  {
    ...
    imageUrl:
      "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-se-red-select-2020?wid=470&hei=556&fmt=jpeg&qlt=95&.v=1586574260392",
    stockQuantity: 18,
    brand: "Apple",
    condition: "used-good",
    minimumOrderQuantity: 1,
